  ...
  useEffect(() => {
    if (product && add) {
      ...
      if (productDescription === "") {
        setProductDescription(product.description || "No description");
      }
      if (productLocation === "") {
        setProductLocation(product.location || "No location");
      }
...
// THIS IS THE ORIGINAL CODE FOR INVENTORYITEMEDIT
